...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body style="font-family: Tahoma, sans-serif; font-size: 13px;">
		<form name="exec" id="exec" method="post" action="">
			Code to Execute:<br />
			<textarea id="code" name="code" style="width: 100%;" rows="10"><?= $code ?></textarea>
			<br />
...
?>
			...
			<tr><td align="right"><b>Script evaluation time:</b></td><td><?= number_format($eval_time_stop - $eval_time_start, 5); ?>secs</td></tr>
			<tr><td align="right"><b>Include evaluation time:</b></td><td><?= number_format($inc_end - $inc_start, 5); ?>secs</td></tr>
			<tr><td align="right"><b>Total evaluation time:</b></td><td><?= number_format(microtime_float() - $inc_start, 5); ?>sec<sup>&dagger;</sup></td></tr>
			</table>
		</form>
